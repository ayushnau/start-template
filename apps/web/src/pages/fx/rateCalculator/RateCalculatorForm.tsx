...
import { CurrencyPairFlags, Header } from "components";
	...
	return (
		<div className="">
			<ReuseInputGroup
				...
				// value={form.getField("pair").split("/").join("→")}
				wrapperClasses="w-full  rounded-xl mt-4"
				className={`${
					form.getField("pair") ? "pl-[52px]" : "pl-4"
				} pr-4 py-3  text-blackDark text-base font-normal rounded-xl border-[1px] h-[56px] border-[#D9D9D9] `}
				placeholder={
					!form.getField("pair")
