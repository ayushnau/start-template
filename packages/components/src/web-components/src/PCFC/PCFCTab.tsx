...
// import LoansListHeader from "../LoanBook/LoansListHeader";

interface PCFCTabProps {
	setNavigationTabSwitch?: Function;
}

const PCFCTab: React.FC<PCFCTabProps> = ({ setNavigationTabSwitch }) => {
