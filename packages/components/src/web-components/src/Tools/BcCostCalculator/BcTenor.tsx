...
export interface BcTenorInterface {
	web?: boolean;
}
const BcTenor: React.FC<BcTenorInterface> = ({ web = false }) => {
	...
	const handleContinueClick = () => {
		dispatch(setbcCostCalculatorNumOfDays(form.value.no_of_days_form));
		dispatch(setbcCostCalculatorLoanDueDate(form.value.loan_due_date_form));
		navigate(
			web === true
				? "/fx-home/fx-tools/bc-sc-calculator/details/loan_amt/tenor/int_rate/"
				: "/fx-home/bc-sc-calculator/details/loan_amt/tenor/int_rate/",
		);
	};
