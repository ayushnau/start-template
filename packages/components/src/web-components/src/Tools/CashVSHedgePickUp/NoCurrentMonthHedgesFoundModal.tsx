					...
					<>
						...
						<div className="px-5 pt-2 flex flex-col gap-y-4">
							<HeadingDescriptionComponent
								heading="No hedges found for the current month"
								description="Add hedges for the current month by tapping ‘Modify hedges’ or utilize hedges from the upcoming months by tapping ‘Continue’."
							/>
							<PrimaryButton
								buttonText="Continue"
								onClick={() => {
							...
							/>
							<SecondaryButton
								buttonText="Modify hedges"
								onClick={() => {
									props.onAction("navigate");
								}}
							/>
						</div>
					</>
...
interface NoCurrentMonthHedgesFoundModalInterface {}

const NoCurrentMonthHedgesFoundModal =
	async ({}: NoCurrentMonthHedgesFoundModalInterface) => {
...
export default NoCurrentMonthHedgesFoundModal;
