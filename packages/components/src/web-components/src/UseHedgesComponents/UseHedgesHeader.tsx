...
import { TradeUsedCounter } from "./TradeUsedCounter";
import { twMerge } from "tailwind-merge";

export interface UseHedgesHeaderInterface {
	percentage: number;
...
const UseHedgesHeader: React.FC<UseHedgesHeaderInterface> = ({
	percentage,
	backArrowCallback,
	remaining_amount,
	hedged_amount,
...
export default UseHedgesHeader;
