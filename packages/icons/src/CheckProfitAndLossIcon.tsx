...
const CheckProfitAndLossIcon = () => {
	return (
		<div className="w-10 h-10 flex items-center justify-center bg-cornflower-blue-5 rounded-full">
			<svg
				width="24"
				height="24"
				viewBox="0 0 24 24"
...
export default CheckProfitAndLossIcon;
